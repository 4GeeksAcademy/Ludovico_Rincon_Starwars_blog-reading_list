        ...
        detailCard !== undefined ? (
            <div className="card mx-1 bg-black text-white cardSize">
                ...
                <div className="card-body mb-0">
                    ...
                    <p className="card-text mb-2">Population: {detailCard.properties.population}</p>
                    <p className="card-text mb-2">Terrain: {detailCard.properties.terrain}</p>
                </div>
